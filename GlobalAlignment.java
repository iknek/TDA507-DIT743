...
public class GlobalAlignment {
	...
	//Simple loop which checks for a dash in the X or Y char. If found in either, it prints a "|".
	for (i=alignmentLength-1 ; i>=0 ; i-- ) {
...
public static int pid(int aLength, char[] alignX, char[] alignY){
	int identity = 0;
	int count = 0;
	...
	identity = (count*100) / 2; //TODO
	
	return identity;
}

public static int hamming(int aLength, char[] alignX, char[] alignY){
	int dist = 0;
